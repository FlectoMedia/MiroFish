      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            ...
            <p class="slogan-text">
              Rehearse the future in agent swarms; sharpen decisions through iteration<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Engine idle — upload data to start a run
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entities · personas · env & sim params</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform sim · forecasts · temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent with tools over the post-sim world</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with anyone in the sim or ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">01 / Real-world seed</span>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe simulation or forecast needs in natural language"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Navigate to Process; API runs there
const startSimulation = () => {
  if (!canSubmit.value || loading.value) return
  
  // Stash pending upload
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    setPendingUpload(files.value, formData.value.simulationRequirement)
    
    // Route to Process with projectId=new
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Space Grotesk for headings; JetBrains Mono for code (loaded in index.html)
  */
