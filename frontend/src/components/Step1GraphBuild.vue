    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM分析文档内容与Simulation requirement，提取出现实种子，自动生成合适的本体结构
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Chunks documents with Zep to build the graph, entities, relations, and temporal memory
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build done — continue to environment setup</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating...' : 'Continue to environment setup ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// Continue to environment setup - 创建 simulation 并跳转
