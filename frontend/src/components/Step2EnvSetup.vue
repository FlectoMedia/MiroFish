    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Creates a simulation instance and loads world templates
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Uses tools over the graph to instantiate agents with behavior and memory from the seed
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            <div class="stat-card">
              ...
              <span class="stat-label">Agents (current)</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ expectedTotal || '-' }}</span>
              <span class="stat-label">Agents (expected)</span>
            </div>
            <div class="stat-card">
              <span class="stat-value">{{ totalTopicsCount }}</span>
              <span class="stat-label">Seed topic count</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Dual-platform simulation config</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM sets time flow, feeds, per-agent activity windows, posting rates, and triggers from your prompt and seed
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Active hours factor</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Feed algorithm</span>
              </div>
              <div class="platforms-grid">
                <div v-if="simulationConfig.twitter_config" class="platform-card">
                  ...
                  <div class="platform-params">
                    <div class="param-row">
                      <span class="param-label">Recency</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.recency_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Hotness</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.popularity_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Relevance</span>
                      <span class="param-value">{{ simulationConfig.twitter_config.relevance_weight }}</span>
                    </div>
                    <div class="param-row">
                      <span class="param-label">Virality threshold</span>
            ...
            <div v-if="simulationConfig.generation_reasoning" class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">LLM reasoning</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            From the narrative, seed initial events and hot topics to bootstrap the world
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">模拟环境已Ready，可以开始运行模拟</p>
          
          <!-- Simulation rounds config - Shown after config is ready and round count is known -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation rounds</span>
                <span class="section-desc">MiroFish plans to simulate  <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of real time; each round is <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>At ~100 agents, estimated runtime ~ {{ Math.round(customMaxRounds * 0.6) }} min</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        At ~100 agents, estimated runtime {{ Math.round(autoGeneratedRounds * 0.6) }} min
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">First run? Switch to custom mode to lower round count for a quick preview and fewer errors ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Stated age (scenario)</span>
              <span class="info-value">{{ selectedProfile.age || '-' }}  yrs</span>
            </div>
            <div class="info-item">
              <span class="info-label">Stated gender (scenario)</span>
            ...
            <div class="info-item">
              <span class="info-label">Stated MBTI (scenario)</span>
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Topics linked to the seed</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Full behavior in this scenario</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral profile</span>
                <span class="dim-desc">Experience and style</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Distinct memories</span>
                <span class="dim-desc">Memories grounded in the seed</span>
              </div>
              <div class="dimension-card">
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generating agent personas' || newStage === 'generating_profiles') {
    ...
    phase.value = 2
    // 进入配置生成阶段，开始polling配置
    if (!configTimer) {
      addLog('开始Dual-platform simulation config...')
      startConfigPolling()
    }
  } else if (newStage === 'Preparing scripts' || newStage === 'copying_scripts') {
...
const autoGeneratedRounds = computed(() => {
  ...
  // Keep max rounds ≥ 40 (recommended) so the slider stays valid
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Starting simulation, auto rounds: ${autoGeneratedRounds.value} rounds`)
  }
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Preparation already done — loading')
      ...
      // 立即设置Agents (expected)（从prepare接口返回值获取）
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`Entities from Zep: ${res.data.expected_entities_count} 实体`)
        if (res.data.entity_types && res.data.entity_types.length > 0) {
          addLog(`  └─ Entity types: ${res.data.entity_types.join(', ')}`)
        }
      }
      
      addLog('Polling prepare status...')
      // 开始polling进度
      startPolling()
      // 开始实时获取 Profiles
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (currentCount === 1) {
          addLog(`开始Generating agent personas...`)
        }
        addLog(`→ Persona ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || 'Unknown role'})`)
        
        // 如果全部生成完成
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`✓ All ${currentCount} Agent人设生成完成`)
        }
      }
    }
  } catch (err) {
    ...
    if (res.success && res.data) {
      ...
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        ...
        if (data.generation_stage === 'generating_profiles') {
          addLog('正在Generating agent personas配置...')
        } else if (data.generation_stage === 'generating_config') {
          addLog('正在调用LLMGenerating simulation config参数...')
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        addLog('✓ Simulation config ready')
        
        // 显示详细配置摘要
        if (data.summary) {
          addLog(`  ├─ Agents: ${data.summary.total_agents}个`)
          addLog(`  ├─ Duration: ${data.summary.simulation_hours}小时`)
          addLog(`  ├─ Initial posts: ${data.summary.initial_posts_count}条`)
          addLog(`  ├─ Hot topics: ${data.summary.hot_topics_count}个`)
        ...
        if (data.config.time_config) {
          ...
          addLog(`Timing: ${tc.minutes_per_round} min/round, ${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}轮`)
        }
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ Environment setup完成，可以Run simulation')
...
const loadPreparedData = async () => {
  phase.value = 2
  addLog('Loading saved config...')

  // 最后获取一次 Profiles
  await fetchProfilesRealtime()
  addLog(`Loaded ${profiles.value.length} Agent人设`)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // 显示详细配置摘要
        if (res.data.summary) {
          addLog(`  ├─ Agents: ${res.data.summary.total_agents}个`)
          addLog(`  ├─ Duration: ${res.data.summary.simulation_hours}小时`)
