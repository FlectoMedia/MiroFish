    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'GraphRAG short/long-term memory updating live' : 'Updating live...' }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Finishing a few updates — try refreshing the graph shortly</span>
...
const renderGraph = () => {
  ...
  simulation.on('tick', () => {
    ...
    // Sync label positions（无旋转，水平显示更清晰）
